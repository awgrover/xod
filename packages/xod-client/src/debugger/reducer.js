...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case EAT.TABTEST_GENERATED_CPP:
      return addPlainTextToTesterLog(MSG.TABTEST_BUILDING, state);
    case EAT.TABTEST_COMPILED:
      return addPlainTextToTesterLog(MSG.TABTEST_RUNNING, state);
    case EAT.TABTEST_RUN_FINISHED:
      return addPlainTextToTesterLog(action.payload.stdout.join('\n'), state);
